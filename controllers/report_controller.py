...
async def get_report_by_environment_id(id: int, inspectionType: str, account: LoggedInUser, service: ReportService = Depends(ReportService)):
    ...
    users_resp_list = [
        {
            ...
            "createdAt": result.createdAt.isoformat(),  # Convert datetime to string
            "value": result.value,
            "title": result.title,
            "inspectionform": {
                "createdAt": result.inspectionform.createdAt.isoformat(),  # Convert datetime to string
                ...
                # Convert datetime to string or None
    ...
    return InspectionresultListResponse(items=users_resp_list)
